<div>
  <div class="mb-4">
    <label for="hs-validation-name-error-name"
      class="mb-2 block text-sm font-medium capitalize dark:text-white">{{ trans('nome') }}<span
  ...
  <div class="mb-4">
    <label for="hs-validation-name-error-password"
      class="mb-2 block text-sm font-medium capitalize dark:text-white">{{ trans('senha') }} @if(!$user) <span
  ...
  <div class="mb-4">
    <label for="hs-validation-name-error-profile_picture"
      class="mb-2 block text-sm font-medium dark:text-white">{{ trans('Escolha foto de perfil') }} </label>
  ...
  <div class="mb-4" wire:ignore>
    <label for="hs-validation-name-error-categories"
      class="mb-2 block text-sm font-medium dark:text-white">{{ trans('Funções') }} <span
        class="text-red-500">*</span></label>
