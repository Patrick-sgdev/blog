              ...
              <div class="hs-dropdown relative inline-flex [--placement:bottom-right]">
                ...
                <div
                  ...
                  <div class="rounded-t-lg bg-gray-100 px-5 py-3 dark:bg-gray-700">
                    <p class="text-sm text-gray-500 dark:text-gray-500">{{ trans('conectado como') }}</p>
      ...
      <div id="hs-application-sidebar"
        ...
        <div class="relative flex h-full max-h-full flex-col">
          <div class="flex justify-center px-6 pt-4">
            <!-- Logo -->
            <a class="inline-block flex-none rounded-xl text-center text-xl font-semibold focus:opacity-80 focus:outline-none dark:text-white"
              href="/" aria-label="Preline">
              <img src="{{ asset_path('logo.webp') }}" alt="" class="size-24">
            </a>
            <!-- End Logo -->
          </div>
          ...
          <div
            ...
            <nav class="hs-accordion-group flex w-full flex-col flex-wrap p-3" data-hs-accordion-always-open>
              <ul class="flex flex-col space-y-1">
                <li>
                  <a @class([
                      'flex items-center gap-x-3.5 rounded-lg [&.active]:bg-blue-500 [&.active]:text-white  px-2.5 py-2 text-sm text-gray-800 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none dark:focus:bg-gray-700 dark:hover:bg-gray-700 [&.active]:dark:bg-gray-700 dark:text-white',
                      'active' => Route::currentRouteName() == 'dashboard.index',
                ...
                <li>
                  <a @class([
                    ...
                    <svg class="size-4 shrink-0" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                      viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                      stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chart-column-stacked">
                      <path d="M11 13H7" />
                      <path d="M19 9h-4" />
                ...
                <li>
                  <a @class([
                    ...
                    <svg class="size-4 shrink-0" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                      viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                      stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-tags">
                ...
                <li>
                  <a @class([
                      'flex items-center gap-x-3.5 rounded-lg [&.active]:bg-blue-500 [&.active]:text-white  px-2.5 py-2 text-sm text-gray-800 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none dark:focus:bg-gray-700 dark:hover:bg-gray-700 [&.active]:dark:bg-gray-700 dark:text-white',
                      'active' => in_array(Route::currentRouteName(), ['dashboard.settings']),
